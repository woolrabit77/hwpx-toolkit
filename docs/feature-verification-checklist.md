...
| P02 | Headers, footers, page numbers, page/section breaks | Multi-section fixture, page-number field inspection, package validation | VERIFYING | — | docs/evidence/verification-P02.md @ 23504b8 |
